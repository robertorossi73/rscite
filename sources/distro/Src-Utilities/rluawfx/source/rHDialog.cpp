...
if(hinstMSHTML)
   ...
   if(pfnShowHTMLDialog)
      ...
      LocalToBSTR(bstr, (LPTSTR)filename, ARRAYSIZE(bstr));
      ...
      if(pmk)
        ...
        varArgs.vt = VT_BSTR;
		LocalToBSTR(bstrDataIn, (LPTSTR)dataIn, ARRAYSIZE(bstrDataIn));
        varArgs.bstrVal = SysAllocString(bstrDataIn);

		LocalToBSTR(bstr2, (LPTSTR)options, ARRAYSIZE(bstr2));
