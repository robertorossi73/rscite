...
Questa procedura consente di utilizzare WinMerge in congiunzione a RSciTE
...
do
  ...
  local function ComparazioneCorrente (compareFolder, compare3, fusion)
    local comparer = props["SciteDefaultHome"].."/tools/winmerge/WinMergeU.exe"
