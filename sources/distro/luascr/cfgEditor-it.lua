...
{
    "Interfaccia per funzione Sostituisci",
    "int", "replace.use.strip", 
    {
        "Utilizza una interfaccia a finestra indipendente (0)","0",
        "Integra l'interfaccia nella finestra principale (1)","1",
        "Valore predefinito", "*REMOVE*"
    },
