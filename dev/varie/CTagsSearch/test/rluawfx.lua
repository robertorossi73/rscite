...
if not(rwfx_info) then
    ...
    function rwfx_ShowList_Repos(lista,titolo,nomeProcedura)
      --TODO : funzione da terminare
      local i
      local sel
      ...
      if not(ListDimensionX) then ListDimensionX = -1 end
      ListDimensionY = rwfx_RegGetInteger(key.."\\showList."..nomeProcedura,"ListDimensionY", "HKCU")
      if not(ListDimensionY) then ListDimensionY = -1 end
    ...
    --verifica se esiste una determinata versione
    --del framework .Net
    --version può valere
    --  "1.1" ritorna true se è presente altrimenti nil
    --  "2.0" ritorna true se è presente altrimenti nil
    --  "3.0" ritorna true se è presente altrimenti nil
    --  "3.5" ritorna true se è presente altrimenti nil
    --  "4.0" ritorna true se è presente altrimenti nil
    --  "" ritorna la versione più recente del framework eventualmente installato
    function rfx_dotNetExist(version)
      local v11 = nil
      local v20 = nil
      local v30 = nil
      local v35 = nil
